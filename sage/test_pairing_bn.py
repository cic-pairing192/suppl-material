...
def test_curve(test_vector_value):
    ...
    test_cofactor_clearing_g2(EM, r, c2, u0, t2, Fq6M, cofactor_clearing_g2_bn, D_twist=False)

    test_membership_testing_g2(EM, r, c2, u0, t2, Fq6M, membership_testing_g2_bn_ehgp, D_twist=False)
    test_membership_testing_g2(EM, r, c2, u0, t2, Fq6M, membership_testing_g2_bn, D_twist=False)
    test_membership_testing_g2(EM, r, c2, u0, t2, Fq6M, membership_testing_g2_bn_alt, D_twist=False)
    ...
    test_bilinear_miller_loop_with_frobenius(miller_loop_opt_ate_bn_alt1, E, E_Fp12M, EM, Fq6M, map_Fq6M_Fp12M, r, c, c2, u0, D_twist=False)
    test_bilinear_miller_loop_with_frobenius(miller_loop_opt_ate_bn_alt2, E, E_Fp12M, EM, Fq6M, map_Fq6M_Fp12M, r, c, c2, u0, D_twist=False)
    ...
    test_cofactor_clearing_g2(ED, r, c2, u0, t2, Fq6D, cofactor_clearing_g2_bn, D_twist=True)

    test_membership_testing_g2(ED, r, c2, u0, t2, Fq6D, membership_testing_g2_bn_ehgp, D_twist=True)
    test_membership_testing_g2(ED, r, c2, u0, t2, Fq6D, membership_testing_g2_bn, D_twist=True)
    test_membership_testing_g2(ED, r, c2, u0, t2, Fq6D, membership_testing_g2_bn_alt, D_twist=True)
    ...
    test_bilinear_miller_loop_with_frobenius(miller_loop_opt_ate_bn_alt1, E, E_Fp12D, ED, Fq6D, map_Fq6D_Fp12D, r, c, c2, u0, D_twist=True)
    test_bilinear_miller_loop_with_frobenius(miller_loop_opt_ate_bn_alt2, E, E_Fp12D, ED, Fq6D, map_Fq6D_Fp12D, r, c, c2, u0, D_twist=True)
...
if __name__ == "__main__":
    ...
    test_vector_bn = [
        ...
        {'u':-(2**94+2**78+2**67+2**64+2**48+1), 'b':2, 'pnbits': 382,  'rnbits':382, 'label':"Aranha et al eprint 2021/1029"},
