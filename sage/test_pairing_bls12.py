...
def test_curve(u0):
    ...
    print("on G1")
    test_cofactor_clearing_g1(E, r, c, u0, t, None, cofactor_clearing_g1_bls12)
    test_membership_testing_g1(E, r, c, u0, t, -beta_mod_p-1, membership_testing_g1_bls12)
    """
    TODO AURORE
    print("on G2, M-twist")
    test_cofactor_clearing_g2(EM, r, c2, u0, t2, Fq6M, cofactor_clearing_g2_bls12, D_twist=False)
    test_membership_testing_g2(EM, r, c2, u0, t2, Fq6M, membership_testing_g2_bls12, D_twist=False)
    print("on G2, D-twist")
    test_cofactor_clearing_g2(ED, r, c2, u0, t2, Fq6D, cofactor_clearing_g2_bls12, D_twist=True)
    test_membership_testing_g2(ED, r, c2, u0, t2, Fq6D, membership_testing_g2_bls12, D_twist=True)
    """
...
def test_curve_bls12_1150():
    # BLS12-1150 seed from https://eprint.iacr.org/2019/1371
    u0 = ZZ(-0xf00000000000000000084000000000000000100000000001)
    test_curve(u0)

if __name__ == "__main__":
    arithmetic(False)
    test_curve_bls12_1150()
